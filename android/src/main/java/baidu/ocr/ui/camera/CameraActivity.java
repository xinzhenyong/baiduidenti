...
import baidu.idcardquality.IDcardQualityProcess;
import com.ziton.bdidentifi.R;
import baidu.ocr.ui.crop.CropView;
import baidu.ocr.ui.crop.FrameOverlayView;
...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_to_edit = (TextView) findViewById(R.id.back_to_edit);
